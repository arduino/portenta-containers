...
#define DSPOTTER_ERR_GetTime					( DSPOTTER_ERR_SDKError - 701 )
#define DSPOTTER_ERR_DifferentVersion			( DSPOTTER_ERR_SDKError - 702 )
#define DSPOTTER_ERR_WrongPackBin				( DSPOTTER_ERR_SDKError - 703 )
